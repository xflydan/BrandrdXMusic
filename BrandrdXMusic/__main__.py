...
async def init():
    ...
    await Hotty.start()
    try:
        await Hotty.stream_call("https://telegra.ph/file/cfe8b6e55ffaa1c3a797a.jpg")
    ...
    LOGGER("BrandrdXMusic").info(
        "ᴅʀᴏᴘ ʏᴏᴜʀ ɢɪʀʟꜰʀɪᴇɴᴅ'ꜱ ɴᴜᴍʙᴇʀ ᴀᴛ @DanteVincente ᴊᴏɪɴ @zxcpy , @dansupport ꜰᴏʀ ᴀɴʏ ɪꜱꜱᴜᴇꜱ"
    )
    await idle()
    await app.stop()
    await userbot.stop()
